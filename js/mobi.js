...
var len = document.getElementsByClassName("product");
var cartOpen = document.getElementById("cartOpen");
cartOpen.addEventListener("mouseover" , ()=>{
  var cartMain = document.getElementById("cartMain1");
  cartMain.style.transition = "opacity .1s linear";
  cartMain.style.opacity = "1";
  var height = "";
  console.log(length);
  if(len.length == 2){
    height = "1050%";
  ...
  cartMain.style.transition = "height .3s ease-in-out";
  cartMain.style.height = height;
  clearTimeout(out);

});

var cartOpen = document.getElementById("cartOpen");
cartOpen.addEventListener("mouseout" , ()=>{
  var cartMain = document.getElementById("cartMain1");
  cartMain.style.transition = "height .2s linear";
  cartMain.style.height = "0";
  out = setTimeout(() => {    
    cartMain.style.transition = "opacity .1s linear";
