        ...
        <nav id="navbar">
            ...
            <ul id="nav-ul">
                ...
                <div class="wh"><a href="index" class="anker-nav"><i class="fas fa-home nav-icons"></i></a></div>
                ...
                <div class="wh cartwh" id="cartOpen"><span id="cartNumber"></span>
                    <i class="fas fa-shopping-cart nav-icons" id="cartMain" onclick=""></i>
                    <div class="cart-main" id="cartMain1">
                        <div class="cart-det" id="cart-table">
                            ...
                            <div id="cartData">
                                ...
                                <!-- <li class="total">
                                    <p>Total</p>
                                    <p style="font-weight:bold;">200000</p>
                                </li> -->
                            </div>
                        </div>
                    </div>
