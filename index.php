    ...
    <section id="sec-nav">
        ...
        <div class="hamburger" id="burger">&#9776;</div>
            <ul id="secNavUl">
                ...
                <li><a href="tablets" class="nav-a nav-aa">Tablets</a></li>
        ...
        <div id="list-nav">
            ...
            <div class="list-side list-smw">
                ...
                <ul class="side-nav-items hideList" id="watchList">
                    <li class="side-nav-li"><a href="">Local</a></li>
    ...
    <section id="center-main">
        <div class="center-div-top">
          <div class="center-box cen-mt">
              ...
              <div class="cen-txt">
                  <a href="smartphones" class="center-img-txt ctr-txt-1">Smart Phones</a>
              </div>
              <a href="smartphones">
            ...
            <div class="cen-txt-dem bot-txt">
                ...
                <div class="cen-txt">
                    <a href="accessories" class="center-img-txt">Accessories</a>
                </div> 
                <a href="accessories">
        ...
        <div class="center-div-top">
            ...
            <div class="cen-txt-dem bot-txt">
                ...
                <div class="cen-txt smw-af">
                    <a href="smartwatches" class="center-img-txt smw-txt-1">Smart Watches</a>
                </div>
                <a href="smartwatches">
