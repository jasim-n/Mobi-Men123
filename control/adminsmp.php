...
if(isset($_POST['action']) && $_POST['action'] == "delete"){
    $sno = $_POST['sno'];
    $dsql = "DELETE FROM `mobiles` WHERE `Sr.no` = '$sno'";
...
if(isset($_POST['action']) && $_POST['action'] == 'edit'){
  ...
  $editsql = "UPDATE `mobiles` SET `item_name` = '$editName', `company` = '$editCompany', `item_price` = '$editPrice', `img_no` = '$editImgNo', `col_no` = '$editColNo', `col-1` = '$editCol1', `col-2` = '$editCol2', `col-3` = '$editCol3', `col-4` = '$editCol4', `col-5` = '$editCol5', `col-6` = '$editCol6', `col-7` = '$editCol7', `col-8` = '$editCol8', `col-9` = '$editCol9', `col-10` = '$editCol10', `color_no` = '$editColorNo', `color-1` = '$editColor1', `color-2` = '$editColor2', `color-3` = '$editColor2', `color-4` = '$editColor4', `color-5` = '$editColor5', `color-6` = '$editColor6' WHERE `mobiles`.`Sr.no` = $editSno";
...
if(isset($_POST['action']) && $_POST['action'] == 'add'){
  ...
  $addsql = "INSERT INTO `mobiles` (`Sr.no`, `item_name`, `company`, `item_price`, `img_no`, `col_no`, `col-1`, `col-2`, `col-3`, `col-4`, `col-5`, `col-6`, `col-7`, `col-8`, `col-9`, `col-10`, `color_no`, `color-1`, `color-2`, `color-3`, `color-4`, `color-5`, `color-6`) VALUES (NULL,'$addName', '$addCompany', '$addPrice', '$addImgNo', '$addColNo', '$addCol1', '$addCol2', '$addCol3', '$addCol4', '$addCol5', '$addCol6', '$addCol7', '$addCol8', '$addCol9', '$addCol10', '$addColorNo', '$addColor1', '$addColor2', '$addColor3', '$addColor4', '$addColor5', '$addColor6')";
...
<h2 class="text-center mt-5">Smart Phones</h2>
<div class="container">
